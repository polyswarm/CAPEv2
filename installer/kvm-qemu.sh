...
function install_virt_manager() {
    ...
    PIP_BREAK_SYSTEM_PACKAGES=1 pip3 install tqdm requests six urllib3 ipaddr ipaddress idna dbus-python certifi lxml pyOpenSSL chardet certvalidator asn1crypto mscerts pycairo PySocks PyGObject pylint pytest
